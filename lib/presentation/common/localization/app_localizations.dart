...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Estamos experimentando algunos problemas temporales. Por favor, inténtalo de nuevo en unos minutos.'**
  String get error_timeout;

  /// No description provided for @error_unauthorized.
  ///
  /// In en, this message translates to:
  /// **'Tu sesión ha expirado y no hemos podido renovarla. Por favor, inicia sesión de nuevo.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Estamos experimentando algunos problemas en este momento. Por favor, vuelve de nuevo mas tarde.'**
  String get error_server;

  /// No description provided for @error_not_found.
  ///
  /// In en, this message translates to:
  /// **'No encontramos lo que necesitas. Por favor, inténtalo de nuevo más tarde.'**
